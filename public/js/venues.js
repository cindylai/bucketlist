...
function displayDetails(response) {
	...
	if (venues === undefined){
		...
		search = "Search Results: <table class='table'>";
		...
		for (var i=0; i<venues.length;i++){
			...
			search += "<tr>";
			search += "<td>"+name+"</td><td><button id='add_venue' class='btn btn-default' type='button'><span class='glyphicon glyphicon-plus'></span></button></td";
			search += "</tr><br>";
